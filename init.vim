...
"
" " If your terminal's background is white (light theme), uncomment the
" following
...
" inoremap <expr> ú col('.')>1 ? 'T<Left><C-o>db<Delete>' :
" '<Backspace>T<Left><c-o>db<Delete>'
" " Requires binding option+forward delete to escape
" inoremap ø <C-o>dw
"
" " Linux / windows ctrl+backspace ctrl+delete
" " Note that ctrl+backspace doesn't work in Linux, so ctrl+\ is also
" available
" imap <C-backspace> ú
" imap <C-\> ú
" imap <C-delete> ø
"
" " Arrow keys up/down move visually up and down rather than by whole lines.
" In
...
"
" autocmd BufNewFile,BufRead *.tex,*.bib noremap <buffer> <C-b>
" :w<cr>:new<bar>r !make<cr>:setlocal buftype=nofile<cr>:setlocal
